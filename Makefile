Casestudy:Company.o Customer.o CustomerReport.o Membership.o MembershipFactory.o RegCustomer.o Program.o
	g++ -std=c++11 -o Casestudy Company.o Customer.o CustomerReport.o Membership.o MembershipFactory.o RegCustomer.o Program.o
